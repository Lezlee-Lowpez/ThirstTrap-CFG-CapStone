...
from db_request import SQLDataHandler
...
class EmailValidator(UserDataHandler):
    ...
    def execute_query(self):
        ...
        try:
            ...
            return "The sql query exexute is wrong"
...
class SignUp(UserDataHandler):
    ...
    def execute_query(self):
        ...
        Raises:
            NotImplementedError: This function has not been implemented yet.
        """
        email = input("Please provide a valid email to sign up: ")
...
class CheckExistenceOfPlants(PlantDataHandler):
    ...
    def execute_query(self):
        """
            ...
            """
        self.sql_request.query = f"SELECT plant_type, plant_nickname, date_last_watered, watering_frequency FROM user_credentials uc JOIN user_plants up ON uc.user_id = up.user_id WHERE username = '{self.user}';"
        return self.sql_request.db_get_record()
...
# hi = CheckExistenceOfPlants('valpal')
# print(hi.execute_query())
